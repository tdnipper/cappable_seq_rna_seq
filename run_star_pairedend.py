...
def signal_handler(sig, frame):
    print("\nExiting...")
    runner_remove_genome = ShellProcessRunner(
...
for key in reads:
    ...
    runner_star = ShellProcessRunner(
        f"STAR \
                                --runThreadN {CPU} \
    ...
    # Convert sam to bam
    runner_convert = ShellProcessRunner(
    ...
    runner_sort_transcriptome = ShellProcessRunner(
    ...
    runner_sort_genome = ShellProcessRunner(
